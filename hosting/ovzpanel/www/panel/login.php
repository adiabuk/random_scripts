...
shell_exec("echo $username >> /var/log/panel.log");
    $plain=$_POST['password'];
    $encrypted=getpassword($username);
    #print "$username";
    $verify=compare_pass($plain,$encrypted);
	if(file_exists('../users/SUSPENDED_' . $username . '.xml')){
