  ...
  class order {
    ...
    function cart() {
      ...
      for ($i=0, $n=sizeof($products); $i<$n; $i++) {
		...
		//////////////////////Start Code changes/////////////////////////////
	  	$products_tax = tep_get_tax_rate($products[$i]['products_tax_class_id']);
		   
		///$products_price =  tep_add_tax($products_price, $products_tax);
		$products_price = $currencies->calculate_price($products[$i]['price'], $products_tax, 1);//$products[$i]['quantity']); 
