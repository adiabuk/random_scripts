...
// remove headers from the encrypted result
        ...
        $process_button_string = tep_draw_hidden_field('cmd', '_s-xclick') .
 				 ...
 				 # Added by adiab on 10/05/10 to enable emails via checkout_process
...
// unregister session variables used during checkout
      ...
      # Removed by adiab on 10/05/10 to allow emails to be sent via checkout_process, see above
