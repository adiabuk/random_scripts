...
*/
  define('MAX_DESCR_1','52'); //
  define('MAX_DESCR_2','794'); //
  define('MAX_DESCR_BESTS','18'); //
  define('MAX_DESCR_REVIEWS','135'); //
  define('MAX_PRODUCT_IN_ROW','2'); //
  define('MAX_PRODUCT_IN_ROW2','1'); //  
// customization for the design layout
  ...
  define('BOX_WIDTH_LEFT', '225'); // how wide the boxes should be in pixels (default: 125)
  define('BOX_WIDTH_RIGHT', 'box_width_right'); // how wide the boxes should be in pixels (default: 125)
  define('BOX_WIDTH','250');
  define('COMPANY', '  a company registered in England under registration number 05817062; <br />
VAT registration number: 883 1805 095; <br />
registered office address: 65 St Mary Street, Chippenham, Wiltshire, SN15 3JF; Fax:44 207 785 9093');
