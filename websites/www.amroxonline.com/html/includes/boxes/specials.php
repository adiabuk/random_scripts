...
// ----------	
	...
	$sp_price_2 = '<del>' . $currencies->display_price($random_product['products_price'], tep_get_tax_rate($random_product['products_tax_class_id'])) . '</del>';
	 ...
	 $sp_price = '<div>'.$sp_price_2.'<br>'.$sp_price_1.'</div>';
    ...
    $info_box_contents[] = array('align' => 'center',
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
						...
						<tr><td style="padding:18px 0px 8px 0px;"><a href="' . tep_href_link('product_info.php?products_id='.$p_id) . '">'.tep_image_button('button_details.gif', '', ' class="btn1"').'</a></td></tr>
                    </table>');
