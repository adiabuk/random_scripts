...
// display 'write a review' box
	...
	<table border="0" cellspacing="5" cellpadding="0">
		<tr><td class="">'.tep_draw_prod_pic2_top().'<a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, 'products_id=' . $HTTP_GET_VARS['products_id']) . '">' . tep_image(DIR_WS_IMAGES . 'box_write_review.gif', IMAGE_BUTTON_WRITE_REVIEW) . '</a>'.tep_draw_prod_pic2_bottom().'</td>
