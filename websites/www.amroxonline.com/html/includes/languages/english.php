...
define('TEXT_GREETING_TITLE_PERSONAL', 'Welcome back <span class="greetUser">%s!</span>');
define('TEXT_GREETING_LOGIN','<a href="login.php"><b><u>Login</u></b></a>');
define('TEXT_GREETING_SIGNUP','<a href="create_account.php"><b><u>Create Account</u></b></a>');
define('TEXT_GREETING_TITLE_GUEST','Welcome Guest');
...
#define('COMPANY', STORE_NAME . ' is a trading name of Amrox Ltd, a company registered in England under registration number 05817062; VAT registration number: 883 1805 095; registered office address: 65 St Mary Street, Chippenham, Wiltshire, SN15 3JF; Fax:44 207 785 9093');

define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a>' . ',Powered by <a href="http://www.oscommerce.com" target="_blank">osCommerce</a> is a trading name of Amrox Ltd,<br/>'
. STORE_NAME . COMPANY);
