...
define('HEADING_NEW_CUSTOMER', '<h3>New Customer</h3>');
define('TEXT_NEW_CUSTOMER', '<h3>I am a new customer.</h3>');
...
define('HEADING_RETURNING_CUSTOMER', '<h3>Returning Customer</h3>');
define('TEXT_RETURNING_CUSTOMER', '<h3>I am a Returning Customer.</h3>');
