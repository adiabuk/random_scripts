...
<?php echo tep_pixel_trans();?>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
	  <tr><td class="main" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_ADVANCED_SEARCH, tep_get_all_get_params(array('sort', 'page')), 'NONSSL', true, false) . '">' . tep_image_button('button_back1.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td></tr>
    </table>
