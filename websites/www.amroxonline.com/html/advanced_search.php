...
<!-- body_text //-->
    <td class="<?php echo CONTENT_WIDTH_TD; ?>"><?php echo panel_top(); ?><?php echo tep_draw_form('advanced_search', tep_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'NONSSL', false), 'get', 'onSubmit="return check_form(this);"') . tep_hide_session_id(); ?>
...
<?php echo tep_pixel_trans();?>
		...
		<table border="0" width="100%" cellspacing="4" cellpadding="2">
          <tr>
            <td class="smallText" style="border:none"><?php echo '<a href="javascript:popupWindow(\'' . tep_href_link(FILENAME_POPUP_SEARCH_HELP) . '\')">' . TEXT_SEARCH_HELP_LINK . '</a>'; ?></td>
            <td class="smallText" align="right" style="border:none"><?php echo tep_image_submit('button_search.gif', IMAGE_BUTTON_SEARCH); ?></td>
          </tr>
        </table>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" width="100%" cellspacing="4" cellpadding="2"><tr>
              ...
              <tr>
                ...
                <td class="smallText" style="border:none"><?php echo tep_draw_checkbox_field('inc_subcat', '1', true) . ' ' . ENTRY_INCLUDE_SUBCATEGORIES; ?></td>
              </tr>
              <tr>
