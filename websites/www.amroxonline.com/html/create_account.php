...
// build the message content
      ...
      $email_text .= EMAIL_WELCOME . EMAIL_TEXT . EMAIL_CONTACT . EMAIL_WARNING . COMPANY;
      tep_mail($name, $email_address, EMAIL_SUBJECT, $email_text, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);

      //execute script
      exec(". /etc/profile; /var/amrox/scripts/new_customer_alert.sh");
...
<?php echo tep_draw1_top();?>
	...
	<table cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td class="stext"><br><?php echo sprintf(TEXT_ORIGIN_LOGIN, tep_href_link(FILENAME_LOGIN, tep_get_all_get_params(), 'SSL')); ?></td>
      </tr>
      <tr>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" cellspacing="4" cellpadding="2">
              <tr>
                ...
                <td class="main radio"><?php echo tep_draw_checkbox_field('newsletter', '1', $checked = true) . '&nbsp;' . (tep_not_null(ENTRY_NEWSLETTER_TEXT) ? '<span class="inputRequirement">' . ENTRY_NEWSLETTER_TEXT . '</span>': ''); ?></td>
              </tr>
            </table>
